...
const AQIComponent = async ({ lat, lon }) => {
  ...
  return (
    <Card>
      <h6 className="feature-name text-center">Air Pollution & Quality</h6>
      <div className="mt-3 space-y-2 lg:space-y-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <span className="text-right text-sm text-green-400  lg:text-base">
